...
public class RiActivity extends AppCompatActivity {

    private static final String TAG = "RiActivity";
    private static final int MIN_YEAR = 1856;
    private static final int MAX_YEAR = 1917;
    ...
    private void setupItemClickListener() {
        seriesListView.setOnItemClickListener((parent, view, position, id) -> {
            Intent intent = new Intent(RiActivity.this, StampsActivity.class);
