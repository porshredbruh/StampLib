...
public class RiUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ri_user);
    ...
    private void loadSeriesFromLocalDatabase() {
        ...
        if (adapter == null) {
            ...
            adapter.setOnItemClickListener(series -> {
                Intent intent = new Intent(RiUserActivity.this, StampsUserActivity.class);
